...
/// <summary>
/// An <see cref="ILoggerProvider"/> that keeps every line anything logged, so a test can search the
/// whole log surface for a secret that should never have been written there.
/// </summary>
